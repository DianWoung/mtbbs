...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-white bg-info">{{ __('用户注册') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group {{ $errors->has('captcha') ? ' has-error' : '' }} row">
                            <label for="captcha" class="col-md-4 text-md-right control-label">验证码</label>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-info">
                                    {{ __('注册') }}<i class="material-icons">trending_flat</i>
                                </button>
                            </div>
                        </div>
                    </form>
